...
model_lstm.save('lstm_model_common')
...
for i, weight in enumerate(weights_before_last):
    np.save(f'weights_before_last_{i}_common.npy', weight)

# Save mean and scale values
np.save('scaler_mean_common.npy', scaler.mean_)
np.save('scaler_scale_common.npy', scaler.scale_)
