...
# Load the datasets
train_df = pd.read_csv('Data/m2_data.csv')
...
for i, weight in enumerate(weights_before_last):
    np.save(f'weights_before_last_{i}_m2.npy', weight)

# Save mean and scale values
np.save('scaler_mean_m2.npy', scaler.mean_)
np.save('scaler_scale_m2.npy', scaler.scale_)
